...
class StopsManager(dict):
    ...
    def __init__(self,depot=None):
        ...
        self.matrix_stops_dist = {}
        self.matrix_depot_dist = {}
    ...
    def init_from_cluster(cls,cluster):
        ...
        """
        current_manager = cls(cluster.depot)
        current_manager.matrix_depot_dist = cluster.matrix_depot_dist
        current_manager.matrix_stops_dist = cluster.matrix_stops_dist
    ...
    def get_diameter(self):
        ...
        tot_pairwise_dist = []
        for stop_1 in self.keys():
            for stop_2 in self.keys():
                dist = self.matrix_stops_dist[stop_1][stop_2]
